                  ...
                  <div className="flex-1 min-w-0 flex flex-col gap-0.5 sm:gap-1">
                    <div className="flex items-center gap-1 sm:gap-2 min-w-0">
                      <div className={`flex items-center flex-1 min-w-0 border rounded-xl overflow-hidden focus-within:ring-2 focus-within:ring-[#8b5cf6] transition-colors shadow-inner ${emptyFields.includes('nickname') ? 'border-red-500 bg-red-50' : 'border-gray-200 bg-white/90'}`}>
                        <span className="pl-2 sm:pl-3 pr-0.5 sm:pr-1 text-gray-400 font-bold select-none cursor-default py-1.5 sm:py-2.5 text-sm sm:text-base">@</span>
                        <input 
                          name="nickname"
                          type="text" 
                          ...
                          placeholder="유튜브 닉네임"
                          className="flex-1 min-w-0 pr-1.5 sm:pr-2.5 py-1.5 sm:p-2.5 focus:outline-none text-[13px] sm:text-base tracking-tight bg-transparent"
                        />
                      </div>
                      <button 
                        type="button" 
                        onClick={() => window.open('https://youtube.com/handle', '_blank')}
                        className="px-1.5 py-1.5 sm:px-2.5 sm:py-2 bg-gradient-to-b from-[#ff4d4d] to-[#cc0000] text-white rounded-xl font-bold text-[10.5px] sm:text-xs tracking-tighter sm:tracking-normal shadow-[0_3px_0_#990000,0_4px_4px_rgba(0,0,0,0.2)] active:shadow-[0_0px_0_#990000,0_1px_2px_rgba(0,0,0,0.3)] active:translate-y-[3px] transition-all shrink-0 flex items-center justify-center gap-0.5 sm:gap-1.5 border border-[#cc0000]"
                      >
                        <svg viewBox="0 0 24 24" fill="currentColor" className="w-[12px] h-[12px] sm:w-[14px] sm:h-[14px]">
